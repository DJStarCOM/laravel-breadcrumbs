...
class ExceptionsTest extends TestCase
{
    ...
    {
        $this->expectException(\DJStarCOM\Breadcrumbs\Exceptions\DuplicateBreadcrumbException::class);
    ...
    {
        $this->expectException(\DJStarCOM\Breadcrumbs\Exceptions\ViewNotSetException::class);
