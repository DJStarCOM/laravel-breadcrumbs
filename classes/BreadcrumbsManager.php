...
namespace DJStarCOM\Breadcrumbs;
...
class BreadcrumbsManager
{
     ...
     * @return void
     * @throws \DJStarCOM\Breadcrumbs\Exceptions\DuplicateBreadcrumbException If the given name has already been
     *     used.
     */
     ...
     * @throws \DJStarCOM\Breadcrumbs\Exceptions\UnnamedRouteException if no name is given and the current route
     *     doesn't have an associated name.
     * @throws \DJStarCOM\Breadcrumbs\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names
     *     are) not registered.
     */
     ...
     * @throws \DJStarCOM\Breadcrumbs\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names are) not registered.
     * @throws \DJStarCOM\Breadcrumbs\Exceptions\UnnamedRouteException if no name is given and the current route doesn't have an associated name.
     * @throws \DJStarCOM\Breadcrumbs\Exceptions\ViewNotSetException if no view has been set.
     */
     ...
     * @throws \DJStarCOM\Breadcrumbs\Exceptions\UnnamedRouteException if the current route doesn't have an associated name.
     * @throws \DJStarCOM\Breadcrumbs\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names are) not registered.
     */
