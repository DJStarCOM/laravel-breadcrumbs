...
namespace DJStarCOM\Breadcrumbs\Exceptions;

use DJStarCOM\Breadcrumbs\BreadcrumbsException;
...
class InvalidBreadcrumbException extends BreadcrumbsException implements ProvidesSolution
{
    ...
    public function getSolution(): Solution
    {
        ...
        $links = [];
        $links['Defining breadcrumbs'] = 'https://github.com/DJStarCOM/laravel-breadcrumbs#defining-breadcrumbs';

        if ($this->isRouteBound) {
            $links['Route-bound breadcrumbs'] = 'https://github.com/DJStarCOM/laravel-breadcrumbs#route-bound-breadcrumbs';
        }

        $links['Silencing breadcrumb exceptions'] = 'https://github.com/DJStarCOM/laravel-breadcrumbs#configuration-file';
        $links['Laravel Breadcrumbs documentation'] = 'https://github.com/DJStarCOM/laravel-breadcrumbs#laravel-breadcrumbs';
